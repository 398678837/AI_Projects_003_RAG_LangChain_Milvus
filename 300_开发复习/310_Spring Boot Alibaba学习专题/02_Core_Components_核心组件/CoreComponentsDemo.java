...
class OrderController {
    ...
    public OrderController(RestTemplate restTemplate, RocketMQTemplate rocketMQTemplate) {
    ...
    public List<Order> getOrdersByUserId(@PathVariable Long userId) {
        // 调用用户服务获取用户信息
        User user = restTemplate.getForObject("http://user-service/api/users/{id}", User.class, userId);
        System.out.println("User: " + user.getName());
        
        // 发送消息到 RocketMQ
        rocketMQTemplate.convertAndSend("order-topic", "Get orders for user: " + userId);
